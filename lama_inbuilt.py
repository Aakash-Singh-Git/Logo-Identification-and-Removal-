...
class Config:
    ...
    YOLO_MODEL_PATH = r"C:\Users\Aakash\Downloads\logo\runs\train\logo_final2\weights\best.pt"
    OUTPUT_FOLDER = r"C:\Users\Aakash\Downloads\logo\mask and output"
    ...
    STABILITYAI_API_KEY = "sk-waqJTG6pZ3Ok7bX3wHaYaPrziSN6LEnr9a7VpFLqIDzSx7s4"
    REPLICATE_API_TOKEN = "r8_UjFXvBoOnhonzs91YZJ9989m5EEOhrq0lDper"
    OPENAI_API_KEY = "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"
    HUGGINGFACE_TOKEN = "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"  # Your token
...
class AIInpainter:
    ...
    def openai_inpaint(self, image, mask):
        """Use OpenAI DALL-E for inpainting - FIXED FOR DALL-E 2"""
        ...
        try:
            ...
            # Prepare images with size constraints
            img_buffer = BytesIO()
            # DALL-E 2 requires square images, max 1024x1024
            ...
            # Ensure mask is correct format (white = transparent, black = keep)
...
class CloudVisionInpainter:
    ...
    def __init__(self):
        self.services = {
            'clipdrop': {
                'name': 'ClipDrop',
                'api_key': '410a91f1b140cd64d807a352c5350f658d7a76ee23ba60ae54c45a3c0c7ceb7f4578b8ce44b7421e7b8fab768bdd4cdb',
